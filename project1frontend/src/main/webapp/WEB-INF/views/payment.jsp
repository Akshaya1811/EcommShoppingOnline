 ...
 <div class="container">
	<div class="row-fluid">
      <form class="form-horizontal">
        <fieldset>
          <div id="legend">
            <legend class=""><b>Payment</b><img src="http://i76.imgup.net/accepted_c22e0.png"></legend>
          </div>
     ...
     <!-- <!-- 
          ...
          <div class="control-group">
            <div class="controls">
             <button  onclick="alert(' you are successfully payed /n pls click done')" class="btn btn-default btn-success"><b>Pay Now</b></button>
            &nbsp&nbsp&nbsp&nbsp
